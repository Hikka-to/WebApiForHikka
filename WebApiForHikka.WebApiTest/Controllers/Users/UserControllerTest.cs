...
public class UserControllerTest : BaseControllerTest
{
    protected void GetAllServicesInServiceCollection(HikkaDbContext dbContext, IServiceCollection alternativeServices)
    {
        ...
        alternativeServices.AddSingleton<IUserSettingService, UserSettingService>();


        alternativeServices.AddSingleton<IFileHelper, FileHelper>();

        alternativeServices.AddSingleton<ILinkFactory, LinkFactory>();
    ...
    protected Mock<IFileHelper> GetFileHelperMock()
    {
        ...
        fileHelperMock.Setup(e => e.OverrideFileImage(It.IsAny<IFormFile>(), It.IsAny<string>()));

        fileHelperMock.Setup(e => e.UploadFileImage(It.IsAny<IFormFile>(), It.IsAny<string[]>()))
            .Returns("mocked/path/to/file");

        fileHelperMock.Setup(e => e.GetFile(It.IsAny<string>()));
    ...
    //    var controller = GetUserController(GetHttpContextAccessForAdminUser());
    ...
    //    var controller = GetUserControllerForAdmin();
