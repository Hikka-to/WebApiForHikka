...
public class SeoAdditionRepository : CrudRepository<SeoAddition>, ISeoAdditionRepository
{
    public SeoAdditionRepository(HikkaDbContext dbContext) : base(dbContext)
    {
    }
    ...
    protected override IQueryable<SeoAddition> Sort(IQueryable<SeoAddition> query, string orderBy, bool isAscending)
    {
