...
{
    protected override IQueryable<Kind> Filter(IQueryable<Kind> query, string filterBy, string filter) => filterBy switch
    {
    ...
    protected override IQueryable<Kind> Sort(IQueryable<Kind> query, string orderBy, bool isAscending) => orderBy switch
    {
