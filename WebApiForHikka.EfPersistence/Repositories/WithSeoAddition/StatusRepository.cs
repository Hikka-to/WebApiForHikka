...
{
    protected override IQueryable<Status> Filter(IQueryable<Status> query, string filterBy, string filter) => filterBy switch
    {
    ...
    protected override IQueryable<Status> Sort(IQueryable<Status> query, string orderBy, bool isAscending) => orderBy switch
    {
