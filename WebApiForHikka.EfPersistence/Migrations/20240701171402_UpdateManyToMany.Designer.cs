...
namespace WebApiForHikka.EfPersistence.Migrations
{
    ...
    [Migration("20240701171402_UpdateManyToMany")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApiForHikka.Domain.Models.ManyToMany.CountryAnime", b =>
                {
            ...
            modelBuilder.Entity("WebApiForHikka.Domain.Models.ManyToMany.DubAnime", b =>
                {
                    b.Property<Guid>("AnimeId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("DubId")
                        .HasColumnType("uuid");

                    b.HasKey("AnimeId", "DubId");
            ...
            modelBuilder.Entity("WebApiForHikka.Domain.Models.ManyToMany.TagAnime", b =>
                {
                    b.Property<Guid>("AnimeId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WebApiForHikka.Domain.Models.ManyToMany.CountryAnime", b =>
                {
                    ...
                    b.HasOne("WebApiForHikka.Domain.Models.WithSeoAddition.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApiForHikka.Domain.Models.ManyToMany.DubAnime", b =>
                {
                    ...
                    b.HasOne("WebApiForHikka.Domain.Models.WithSeoAddition.Dub", "Dub")
                        .WithMany()
                        .HasForeignKey("DubId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebApiForHikka.Domain.Models.ManyToMany.TagAnime", b =>
                {
                    ...
                    b.HasOne("WebApiForHikka.Domain.Models.WithSeoAddition.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
